# HPayments PHP Client ![Generic badge](https://img.shields.io/badge/v-2.0.3-<COLOR>.svg) [![MIT license](https://img.shields.io/badge/License-MIT-blue.svg)](https://lbesson.mit-license.org/)
...
After doing required changes, you must change version in `const CLIENT_VERSION` and `Readme.md`.
Also add version information to `CHANGELOG.md`.
